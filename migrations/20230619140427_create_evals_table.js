...
exports.up = function(knex) {
    return knex.schema.createTable('evals', (table) => {
        ...
        table.integer("judge_num").unsigned().defaultTo(0).notNullable();
        table.integer("judge_score").unsigned().defaultTo(0).notNullable();
...
exports.down = function(knex) {
    return knex.schema.dropTable('evals');
};
